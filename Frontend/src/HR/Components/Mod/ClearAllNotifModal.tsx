...
const ClearAllNotifModal: React.FC<Props> = ({ isOpen, onClose, onConfirm, isLoading }) => {
      ...
      <div className="relative w-full max-w-xs bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100 animate-in zoom-in-95 duration-200">
        ...
        <div className="p-5">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-base font-bold text-gray-900 mb-1">Clear all notifications?</h3>
...
export default ClearAllNotifModal;
