...
function PassConformationOtpModal({ isOpen, onConfirm, onClose, isVerifying, isInvalid, reSentOtp }: OTPModalProps) {
        ...
        <div className="px-8 pt-7 pb-8">
          ...
          <div className="text-center mb-7">
            ...
            <p className="text-[13.5px] text-gray-400 leading-6 font-normal tracking-normal">
              We sent a 6‑digit password change verification code<br />to your email address.
            </p>
          </div>
...
export default PassConformationOtpModal;