              ...
              <>
                ...
                <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden mb-4">
                  <div className="flex items-center gap-3 px-6 py-3 bg-gray-50/60 border-b border-gray-100">
                    ...
                    <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-gray-500">Profile</p>
                  </div>
                  <div className="px-6 py-5 grid grid-cols-2 gap-5">
                    <div>
                      <p className="text-[10px] text-gray-400 uppercase tracking-wide font-medium mb-0.5">Full Name</p>
                      <p className="text-sm font-semibold text-gray-800">{data.developerName}</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-gray-400 uppercase tracking-wide font-medium mb-0.5">Email</p>
                      <p className="text-sm font-semibold text-gray-800 truncate">{data.developerEmail}</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-gray-400 uppercase tracking-wide font-medium mb-0.5">Position</p>
                    ...
                    <div>
                      <p className="text-[10px] text-gray-400 uppercase tracking-wide font-medium mb-0.5">Experience</p>
                      <span className="inline-flex items-center gap-1.5 text-xs font-medium text-gray-600 bg-gray-50 border border-gray-200 px-2.5 py-1 rounded-lg">
                  ...
                  <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden mb-4">
                    <div className="flex items-center justify-between px-6 py-3 bg-gray-50/60 border-b border-gray-100">
                      <div className="flex items-center gap-3">
                        ...
                        <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-gray-500">Interview Details</p>
                      </div>
                      {status && (
                        <span className={`inline-flex items-center gap-1 ${status.bg} border ${status.border} ${status.text} text-[9px] font-semibold px-2 py-0.5 rounded-full uppercase tracking-wide`}>
                          {status.icon}
                          {status.label}
                        </span>
                      )}
                    ...
                    <div className="px-6 py-5 grid grid-cols-2 gap-5">
                      <div>
                        <p className="text-[10px] text-gray-400 uppercase tracking-wide font-medium mb-0.5">Date</p>
                      ...
                      <div>
                        <p className="text-[10px] text-gray-400 uppercase tracking-wide font-medium mb-0.5">Time</p>
                        <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-gray-700">
                      ...
                      <div>
                        <p className="text-[10px] text-gray-400 uppercase tracking-wide font-medium mb-0.5">HR</p>
                        <p className="text-xs font-semibold text-gray-800">{interview.hr.name}</p>
                      </div>
                      <div>
                        <p className="text-[10px] text-gray-400 uppercase tracking-wide font-medium mb-0.5">Company</p>
                        <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-gray-700">
                ...
                {task && diff ? (
                  <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden mb-4">
                    <div className="flex items-center gap-3 px-6 py-3 bg-gray-50/60 border-b border-gray-100">
                      ...
                      <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-gray-500">Assigned Task</p>
                    </div>
                    <div className="px-6 py-5 space-y-4">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <h2 className="text-sm font-bold text-gray-900">{task.title}</h2>
                          <span className={`text-[9px] font-semibold px-2 py-0.5 rounded-full border ${diff.bg} ${diff.text} ${diff.border} capitalize`}>
                            {task.difficulty}
                          </span>
                        </div>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {task.techStack.split(",").map((t, i) => (
                          <span key={i} className="text-xs font-medium bg-gray-50 border border-gray-200 text-gray-600 px-2.5 py-0.5 rounded-lg">
                            {t.trim()}
                          </span>
                        ))}
                      </div>
                  ...
                  <div className="bg-white border border-gray-100 rounded-2xl p-8 text-center">
                    ...
                    <p className="text-xs text-gray-400 mt-1">Your HR will assign a task before the interview</p>
                  </div>
                )}
              </>
            );
