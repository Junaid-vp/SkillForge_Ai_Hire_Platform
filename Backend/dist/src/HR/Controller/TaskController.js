...
export const submitTask = async (req, res) => {
    try {
        ...
        await createNotification(task.hrId, "Task Submitted", `Task "${task.taskLibrary?.title ?? ""}" submitted by ${task.developer?.developerName ?? "developer"}.`, "TASK_SUBMITTED", true);
