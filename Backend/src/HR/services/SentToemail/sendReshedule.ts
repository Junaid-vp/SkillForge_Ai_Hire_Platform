...
<table width="480" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;border:1px solid #e2e8f0;box-shadow:0 8px 40px rgba(0,0,0,0.06);overflow:hidden;">
  ...
  <!-- Accent bar -->
  <tr><td style="height:4px;background:linear-gradient(to right,#f59e0b,#ef4444);"></td></tr>
  ...
  <!-- Title -->
  <tr><td style="padding:24px 48px 6px;">
  ...
  <tr><td style="padding:24px 48px;">
    <table width="100%" cellpadding="0" cellspacing="0" style="border-radius:12px;overflow:hidden;border:1px solid #e2e8f0;">
      ...
      <tr><td style="padding:13px 20px;background:#f8fafc;border-bottom:1px solid #e2e8f0;">
      ...
      <tr><td style="padding:18px 20px;border-bottom:1px solid #f1f5f9;">
  ...
  <tr><td style="padding:0 48px 24px;">
    <table width="100%" cellpadding="0" cellspacing="0">
      <tr><td style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:12px;padding:22px 24px;text-align:center;">
        <p style="margin:0 0 4px;font-size:10px;font-weight:700;letter-spacing:0.15em;text-transform:uppercase;color:#3b82f6;">Your Access Code Remains</p>
        <p style="margin:0 0 12px;font-size:12px;color:#64748b;">Your original code is still valid for the new session</p>
        <p style="margin:0;font-size:30px;font-weight:800;color:#1d4ed8;letter-spacing:0.35em;font-family:'Courier New',monospace;">${UniqueCode}</p>
      </td></tr>
    </table>
  </td></tr>
  ...
  <tr><td style="padding:0 48px 24px;">
    <table width="100%" cellpadding="0" cellspacing="0">
      <tr><td style="background:#fffbeb;border-left:3px solid #f59e0b;border-radius:0 8px 8px 0;padding:13px 16px;">
